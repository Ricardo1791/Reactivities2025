    ...
    public class MappingProfiles: Profile
    {
        public MappingProfiles() 
        {
            ...
            CreateMap<Activity, ActivityDto>()
                .ForMember(d => d.HostDisplayName, o => o.MapFrom(s => s.Atendees.FirstOrDefault(x => x.IsHost)!.User.DisplayName))
                .ForMember(d => d.HostId, o => o.MapFrom(s => s.Atendees.FirstOrDefault(x => x.IsHost)!.User.Id));
